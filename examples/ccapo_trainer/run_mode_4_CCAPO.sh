...
function cleanup {
    echo "[cleanup] Script exiting, restoring GPU compute mode..."
...
echo "[lock] Setting GPUs ${GPUS_TO_LOCK} to EXCLUSIVE_PROCESS..."
for GPU_ID in $GPUS_TO_LOCK; do
...
VAL_BATCH_SIZE=8
GROUP_SIZE=4
EXPERIMENT_NAME="ccapo_mode4_full_ccapo"
MAX_STEPS=50
...
echo ">>> [2/2] Starting CCAPO Training - Mode 4: Dual-Stream Advantage (Full CCAPO)..."
...
python3 -m verl.trainer.main_ppo \
    ...
    ++algorithm.ccapo.beta_micro=0.3 \
    ...
    2>&1 | tee logger/ccapo_mode4_full_ccapo.log
