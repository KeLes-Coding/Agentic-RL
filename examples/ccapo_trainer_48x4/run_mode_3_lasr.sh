...
VAL_BATCH_SIZE=128
GROUP_SIZE=8
EXPERIMENT_NAME="ccapo_mode3_lasr_48x4"
MAX_STEPS=50
...
echo ">>> [2/2] Starting CCAPO Training - Mode 3: CCAPO Reward + LASR (Full)..."
...
python3 -m verl.trainer.main_ppo \
    ...
    ++algorithm.ccapo.lasr.enable=true \
    ++algorithm.ccapo.lasr.beta=1.0 \
    ...
    2>&1 | tee logger/ccapo_mode3.log
