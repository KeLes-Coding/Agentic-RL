...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_source', default=None, type=str)
    parser.add_argument('--ability', default='agent', type=str)

    args = parser.parse_args()
    print(f"processing data for mode: {args.mode}")
    args.local_dir = os.path.join(args.local_dir, args.mode)
    output_data_source = args.data_source if args.data_source is not None else args.mode
